...
public class BreederSpecialRenderer extends ItemSpecialRendererBase<BreederTileentity, BreederRenderState> {
    ...
    public BreederSpecialRenderer(EntityModelSet modelSet, BlockModelResolver blockModelResolver, Supplier<BlockState> blockSupplier) {
        super(blockSupplier, BreederTileentity.class);
        renderer = new BreederRenderer(modelSet, blockModelResolver);
    }
    ...
    public static class Unbaked implements SpecialModelRenderer.Unbaked<BreederTileentity> {
        ...
        public SpecialModelRenderer<BreederTileentity> bake(BakingContext context) {
            return new BreederSpecialRenderer(context.entityModelSet(), Minecraft.getInstance().getBlockModelResolver(), () -> ModBlocks.BREEDER.get().defaultBlockState());
        }
